...
proc finish {} {
        ...
        close $tf
        exec nam out.nam &      
        exec awk -f CodeLinux1.awk out.tr &  
        exec awk -f CodeLinux2.awk out.tr &  
        exit 0
}
...
#Creating FTP source and attaching it to TCP Agent
set ftp1 [new Application/FTP]
$ftp1 attach-agent $tcp1
$ftp1 set type_ FTP

#Creating a TCP agent LINUX-2
