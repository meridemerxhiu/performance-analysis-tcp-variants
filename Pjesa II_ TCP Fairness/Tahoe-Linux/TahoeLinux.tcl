...
set windowVsTime2 [open WindowVsTime_Tahoe-Linux w]
...
proc finish {} {
        ...
        close $tf
        exec nam out.nam &
	exec awk -f codeLinux.awk out.tr &     
        exec awk -f codeTahoe.awk out.tr &
        exit 0
}
